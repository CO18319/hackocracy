...
if (isset($_GET['pid'])) {
  $pid = $_GET['pid'];
  $sql2 = "SELECT `problem_title`, `problem_statement`, `testcase_input1`, `testcase_output1`, `testcase_input2`, `testcase_output2` FROM `problems` WHERE `pid`=$pid;";
...
<head>
  ...
  <title>Logo | Admin Dashboard</title>
