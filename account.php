...
<head>
    ...
    <title>Logo | Account Settings</title>
                        ...
                        <div class="form-row align-items-center">
                          ...
                          <div class="col-sm-3 my-1">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control" id="confirmPass1" placeholder="Confirm Password">
                            </div>
                          </div>
                    ...
                    <form>
                        <div class="form-row align-items-center">
                          <div class="col-sm-3 my-1">
                            ...
                            <input type="text" class="form-control" id="inlineFormInputName" placeholder="New Password">
                          </div>
                          <div class="col-sm-3 my-1">
                            <label class="sr-only" for="confirmPass2">Confirm Password</label>
                            <div class="input-group">
                              <input type="text" class="form-control" id="confirmPass2" placeholder="Confirm Password">
                            </div>
                          </div>
